...
from graphrag.index.cleaner.clean_processor import CleanProcessor
from graphrag.index.text_splitting.text_splitting import RecursiveCharacterTextSplitter
...
if __name__ == "__main__":
    text_splitter = ChineseRecursiveTextSplitter(
        keep_separator=True, is_separator_regex=True, chunk_size=50, chunk_overlap=5
    )
    ls = [
